...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2021 at 08:05 AM
...
CREATE TABLE `documents` (
  ...
  `ref_document` varchar(50) DEFAULT NULL COMMENT 'Reference Document for avoiding duplication',
...
--
ALTER TABLE `activity_log`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1176;
...
--
ALTER TABLE `affiliate_compliance_status_monthly`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=670;
...
--
ALTER TABLE `legal_document_status`
  MODIFY `legal_d_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `monthly_document_status`
--
ALTER TABLE `monthly_document_status`
  MODIFY `monthly_document_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75178;
...
--
ALTER TABLE `performance_impli_mission_document_status`
  MODIFY `performance_i_m_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;

--
-- AUTO_INCREMENT for table `performance_org_sndns_document_status`
--
ALTER TABLE `performance_org_sndns_document_status`
  MODIFY `performance_o_s_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3239;

--
-- AUTO_INCREMENT for table `performance_other_document_status`
--
ALTER TABLE `performance_other_document_status`
  MODIFY `performance_o_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2139;

--
-- AUTO_INCREMENT for table `performance_vitality_document_status`
--
ALTER TABLE `performance_vitality_document_status`
  MODIFY `performance_v_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5651;

--
-- AUTO_INCREMENT for table `quarterly_document_status`
--
ALTER TABLE `quarterly_document_status`
  MODIFY `quarterly_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8366;
...
--
ALTER TABLE `self_assessment`
  MODIFY `self_assessment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `yearly_document_status`
  MODIFY `yearly_d_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7125;
