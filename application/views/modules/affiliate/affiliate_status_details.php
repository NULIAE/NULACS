					...
					<div class="tab-pane fade <?php if($tabSelected==1) echo 'show active'; ?>" id="nav-x1" role="tabpanel" aria-labelledby="nav-x1-tab">
						...
						<div class="tab-content" id="nav-tabContent-nner">
															...
															<div class="row  align-items-center" id="month-row-<?php echo $document['document_id']; ?>">
																...
																<div class="col-14 col-md-6" id="document-name-<?php echo $document['document_id']; ?>">
																	<?php if(isset($currentDoc)) : ?>
																		...
																		<?php if(($currentDoc['monthly_compliance_status'] == 5) && ($this->session->role_id == 1)): ?><a href="#" data-document="<?php echo $document['document_id']; ?>" data-interval="month" data-uploadid="<?php echo $currentDoc['monthly_document_id']; ?>" class="deletedoc float-left pl-1"><span class="sub pl-1"><i class="i i-delete"></i></span><?php endif; ?></a>
																	<?php else: ?>
														...
														<div class="btn wrdiv <?php  echo ($key%2 != 0)? "odd": ""; ?>">
															<div class="row  align-items-center" id="quarter-row-<?php echo $document['document_id']; ?>">
																...
																<?php if(isset($currentDoc)) : ?>
																		...
																		<?php if(($currentDoc['quarterly_compliance_status'] == 5) && ($this->session->role_id == 1)): ?><a href="#" data-document="<?php echo $document['document_id']; ?>" data-interval="quarter" data-uploadid="<?php echo $currentDoc['quarterly_id']; ?>" class="deletedoc float-left pl-1"><span class="sub pl-1"><i class="i i-delete"></span></i><?php endif; ?></a>
																	<?php else: ?>
																		<span class="sub"><?php echo $document['document_name']; ?></span>
																	<?php endif; ?>
																</div>
							...
							<div class="tab-pane fade" id="nav-y3" role="tabpanel" aria-labelledby="nav-y3-tab">
								<div class=" m-y-20">
									<?php $endDate = explode('-', $affiliate['year_end']); ?>
									<?php $endDate[2] = 1; ?>
									<?php $year_end = implode('-', $endDate); ?>
									<?php $startMonth = date('m', strtotime("+1 month", strtotime($year_end))); ?>
									<div class="h5 t-c f-bold">
										...
										YEARLY (<?php echo strtoupper(date('M Y', mktime(0, 0, 0, $startMonth, 1, $yearly_year))); ?> - <?php echo strtoupper(date('M Y', strtotime("+11 month", mktime(0, 0, 0, $startMonth, 1, $yearly_year)))); ?>)
								...
								<div class="cdnWrap">
															...
															<div class="row  align-items-center" id="year-row-<?php echo $document['document_id']; ?>">
																...
																<div class="col-14 col-md-6" id="document-name-<?php echo $document['document_id']; ?>">
																	<?php if(isset($currentDoc)) : ?>
																		...
																		<?php if(($currentDoc['yearly_compliance_status'] == 5) && ($this->session->role_id == 1)): ?><a href="#" data-document="<?php echo $document['document_id']; ?>" data-interval="year" data-uploadid="<?php echo $currentDoc['yearly_d_id']; ?>" class="deletedoc float-left pl-1"><span class="sub pl-1"><i class="i i-delete"></i></span><?php endif; ?></a>
																	<?php else: ?>
																		<span class="sub"><?php echo $document['document_name']; ?></span>
																	<?php endif; ?>
																</div>
									...
									<div class="row align-items-center ">
										...
										<div class="col-lg-12">
											<div class="p-a-15 text-lg-right">
											<span class="h5">Affiliate yearly compliance for <?php echo strtoupper(date('M Y', mktime(0, 0, 0, $startMonth, 1, $yearly_year))); ?> - <?php echo strtoupper(date('M Y', strtotime("+11 month", mktime(0, 0, 0, $startMonth, 1, $yearly_year)))); ?></span>
											</div>
										</div>
										<div class="col-lg-12 <?php if($this->session->role_id == 1) echo "update-status"; ?>">
