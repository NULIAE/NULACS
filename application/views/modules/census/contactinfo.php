                      ...
                      <div class="row g-4 align-items-end p-b-20">
                        <div class="col-md-24">
                          <div class="form-group">
                            ...
                            <input type="file" name="photo" id="photo" accept=".jpg, .jpeg, .png" onchange="checkFileSize()"/><br>
                            <p class="file_accept">*Only .jpg, .jpeg and .png files are allowed.</p>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Photo: </td>
                               <td>
                                <span>
                                  <?php if(isset($report_data[0]['field_photo_title'])){ ?><img src="<?php echo base_url('/resources/images/profile/'.$report_data[0]['field_photo_title']);?>" style="width: 50vh;"?><?php } ?>
                                </span></td>
                            </tr>
                            <?php if ($this->session->role_id == 1) { ?>
                              <tr>
