								...
								<form id="edit-emergency" method="post" action="<?php echo base_url('module/forms_update/emergency/update'); ?>">
									...
									<div class="">
										<div class="form-group t-c formclassbtn">
											<button class="btn btn-primary m-r-15 btn-rounded" type="submit">SAVE</button>
											<button class="btn btn-danger m-r-15 btn-rounded" type="button" data-status_id="<?= $statuses['emergency_relief']['status'];?>" data-table_name="emergency_relief" id="delete_button" value="<?php echo $content['report_data'][0]['field_parent_census'] ?>">DELETE</button>
