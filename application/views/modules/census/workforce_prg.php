									...
									<div class="form-group t-c formclassbtn" style="text-align: right;">
										...
										<div class="row g-4 align-items-end  ">
											...
											<div class="col-24" id="hide_div_if_no">
												...
												<div class="h5 Subtittle">Person Who Oversees Work Programs</div>
										...
										<div class="">
											<div class="form-group t-c formclassbtn">
												<button class="btn btn-primary m-r-15 btn-rounded" type="submit">SAVE</button>
												<button class="btn btn-danger m-r-15 btn-rounded" type="button" data-table_name="workforce_develop_program" id="delete_button" value="<?php echo $content['report_data'][0]['field_parent_census'] ?>">DELETE</button>
