...
$("#edit-employee").submit(function (event) {
	...
	$.ajax({
		...
		success:function(data){                    
			window.location.href = base_url + 'module/census_report/'+ parent_census +'/employees?msg=updateSuccess';
		}
	});
...
function tabstatus_change(elem,parent_census,status) {
	...
	$.ajax({
		...
		success:function(data){
			if (data) {
				window.location.href = base_url + 'module/census_report/'+ parent_census +'/employees?tab_message=updateSuccess';
			} else {
				window.location.href = base_url + 'module/census_report/'+ parent_census +'/employees';
