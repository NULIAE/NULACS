...
--
-- Table structure for table `covid_impact_services_requested_value`
--

CREATE TABLE `covid_impact_services_requested_value` (
  `id` int(11) NOT NULL,
  `covid_impact_services_requested_id` int(11) NOT NULL,
  `value` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `covid_impact_services_requested_value`
--

INSERT INTO `covid_impact_services_requested_value` (`id`, `covid_impact_services_requested_id`, `value`) VALUES
...
--
-- Indexes for table `covid_impact_services_requested_value`
--
ALTER TABLE `covid_impact_services_requested_value`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `covid_impact_services_requested_value`
--
ALTER TABLE `covid_impact_services_requested_value`
